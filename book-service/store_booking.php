...
$stmt->bind_param("sssiisssssss", $location, $serviceType, $subService, $hours, $workers, $bookingDate, $bookingTime, $customerName, $customerEmail, $customerPhone, $paymentMethod, $cardNumber);
...
if ($stmt->execute()) {
    ...
    echo "<script>alert('Booking stored successfully$customerName !'); window.location.href = 'booking.php';</script>";
} else {
