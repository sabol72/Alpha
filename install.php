      ...
      <div class="container">
        ...
        <div class="row gy-5">
          ...
          <div class="col-lg-4" data-aos="fade-up" data-aos-delay="100">
            ...
            <div class="service-box">
              ...
              <div class="services-list">
                <a href="install.php" class="active"><i class="bi bi-arrow-right-circle"></i><span>AC Installation</span></a>
                ...
                <a href="repair.php"><i class="bi bi-arrow-right-circle"></i><span>AC Repair</span></a>
          ...
          <div class="col-lg-8 ps-lg-5" data-aos="fade-up" data-aos-delay="200">
            <img src="install.jpg" alt="" class="img-fluid services-img">
        ...
        <div class="col-lg-6 mb-4">
          <div class="service-item item-cyan position-relative p-4 d-flex align-items-center">
            ...
            <div>
              ...
              <p style="color: black;  font-size: 14px;">If you’re looking for a reliable AC installation service in Dubai, look no further than Al Bahja Building
